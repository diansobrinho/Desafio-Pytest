...
10	PUT	test_atualizar_dados_de_usuario_existente	Valida a alteration completa dos dados cadastrais de um usuário ativo.	200 OK
...
Siga os passos abaixo no terminal para clonar e preparar o ambiente de testes:
...
Provisionar o Ambiente Virtual (Venv):
...
Instalar Dependências Escrupulosamente Fixadas:
